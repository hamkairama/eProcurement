        ...
        <div class="main-content-inner">
            <div class="page-content">
                <div class="row">
                            ...
                            <table id="table_input" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Convrt(RP)</th>
                                        <th>PO No</th>
                                        <th style="display:none">SuppId</th>
                                    ...
                                    @code
                                        ...
                                        @For Each item In Model.TPROC_PR_DETAIL
                                            @<tr style="background-color: @CommonFunction.ConvertStatusItem(item.PR_DETAIL_STATUS)">
                                                ...
                                                @if item.PR_DETAIL_STATUS <> ListEnum.ItemStatus.Rejected Then
                                                    @<td><input size=15 type="text" id="txt_supplier_name_@no" onclick="getSupplier(this)" value="@item.SUPPLIER_NAME" /></td>
                                                Else
                                                    @<td><input size=15 type="text" id="txt_supplier_name_@no" value="@item.SUPPLIER_NAME" readonly="readonly" /></td>
                                                End If
                                                                                    
                                                <td style="">@item.CONVERSION_RP.Value.ToString("###,###")</td>
                                                <td style="">@item.PO_NUMBER</td>
                                                <td style="display:none"><input size=2 type="text" id="txt_supplier_id_@no" value="@item.SUPPLIER_ID" /></td>
                                                <td>
                    ...
                    @if Model.PR_STATUS <> Convert.ToInt32(ListEnum.PRStatus.PrRejected) Then
                        @<div Class="form-group">
