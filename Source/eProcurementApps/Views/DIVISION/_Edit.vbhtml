@ModelType eProcurementApps.Models.TPROC_DIVISION
            ...
            <div class="profile-user-info">
                ...
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value item-required">
                        <span class="freeText change" id="txt_division_name" maxlenght="50">@Model.DIVISION_NAME</span>
                ...
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="freeText" id="txt_division_description">@Model.DIVISION_DESCRIPTION</span>
                    </div>
                </div>
