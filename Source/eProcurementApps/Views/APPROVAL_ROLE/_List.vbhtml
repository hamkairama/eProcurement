@ModelType IEnumerable(Of eProcurementApps.Models.TPROC_APPROVAL_ROLE_GR)
                ...
                <div Class="row">
                    <div Class="col-xs-12">
                        ...
                        <div class="table-header">
                            <a class="red" href="@Url.Action("Create", "APPROVAL_ROLE", New With {.flag = Convert.ToDecimal(ViewBag.flag)})" title="Create">
                                        ...
                                        @<tr>
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="@Url.Action("Edit", "APPROVAL_ROLE", New With {.id = item.ID, .flag = Convert.ToDecimal(ViewBag.flag)})" title="Edit">
                                                        @Html.Raw(Labels.IconAction("Edit"))
                                                    </a>
                                                    <a class="red" href="@Url.Action("Delete", "APPROVAL_ROLE", New With {.id = item.ID, .flag = Convert.ToDecimal(ViewBag.flag)})" title="Delete">
