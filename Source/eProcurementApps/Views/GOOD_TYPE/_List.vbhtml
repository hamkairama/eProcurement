@ModelType IEnumerable(Of eProcurementApps.Models.TPROC_GOOD_TYPE)
                    ...
                    <div Class="col-xs-12">
                        <div Class="clearfix">
                            <div Class="pull-right tableTools-container">
                                <button title="Export to xls" class="btn btn-white btn-info btn-bold" id="export" onClick="fnExcelReport('export', 'dynamic-table', 'GoodType')">
                                    <span>
