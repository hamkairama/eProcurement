        ...
        <div class="modal-body no-padding">
            <div class="profile-user-info">
                ...
                <div class="profile-info-row">
                    <div class="profile-info-name"> PO Type </div>
                    <div class="profile-info-value">
                        <span>@Model.PO_TYPE_NAME</span>
                    </div>
                </div>

                <div class="profile-info-row">
                    <div class="profile-info-name "> Form Type Id</div>
                    <div class="profile-info-value ">
                        <span id="">@Model.TPROC_FORM_TYPE.FORM_TYPE_NAME</span>
                    </div>
                </div>
                ...
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span>@Model.PO_TYPE_DESCRIPTION</span>
                    </div>
                </div>
