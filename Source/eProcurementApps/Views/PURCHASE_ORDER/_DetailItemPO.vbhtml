                ...
                <thead>
                    ...
                    <tbody>
                        @For Each item In Model.TPROC_PO_DETAILS
                            ...
                            @<tr>
                                <td><a href="@Url.Action("DetailHeaderByPrNo", "PURCHASING_REQUEST", New With {.pr_no = item.PR_HEADER_NO})" target="_blank" >@item.PR_HEADER_NO</a></td>
                                <td>@item.USERMEASUREMENT</td>
                                <td>@item.QUANTITY.Value.ToString("###,###")</td>
            ...
            @<div Class="hr hr-18 dotted hr-double"></div>
                    @<div Class="row">
                        ...
                        <div Class="col-xs-4" style="font-weight:bold">
                            <div>
                                Rp. <span>@valTotal.ToString("###,###")</span>
                            </div>
                        </div>
                    </div>
            @<div Class="hr hr-18 dotted hr-double"></div>
