@ModelType IEnumerable(Of eProcurementApps.Models.TPROC_ROLE)
                    ...
                    <div Class="col-xs-12">
                        <div Class="clearfix">
                            <div Class="pull-right tableTools-container">
                                <button title="Export to xls" class="btn btn-white btn-info btn-bold" id="export" onClick="fnExcelReport('export', 'dynamic-table', 'Roles')">
                                    <span>
                        ...
                        <div class="table-header">
                            <a class="red" href="@Url.Action("Create", "Role")" title="Create">
                                ...
                                <tbody>
                                    @For Each item In Model
                                        @<tr>
                                            ...
                                            End Code
                                            @code
                                                If item.DEFAULT_SELECTED = 1 Then
                                                     @<td>Yes</td>
                                                Else
                                                     @<td>No</td>
                                                End If
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a class="blue" href="@Url.Action("Details", "Role", New With {.id = item.ID})" title="View">
                                                        @Html.Raw(Labels.IconAction("Details"))
                                                    </a>

                                                    <a class="green" href="@Url.Action("Edit", "Role", New With {.id = item.ID})" title="View">
