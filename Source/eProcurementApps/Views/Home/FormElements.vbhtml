@Code
    ...
    ViewBag.Title = "Form Element"
    ViewBag.Home = "active open"
    ViewBag.FormElements = "active"
End Code


@Styles.Render("~/Bundle/Ace/FormElements/css")
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                ...
                                                <div>
                                                    <label for="form-field-select-3">Chosen2</label>
...
@Scripts.Render("~/Bundle/Ace/FormElements/js")
...
<script src="~/Scripts/Standard/StandardForm.js"></script>