@ModelType IEnumerable(Of eProcurementApps.Models.TPROC_REL_DEPT)
                    ...
                    <div Class="col-xs-12">
                        <div Class="clearfix">
                            <div Class="pull-right tableTools-container">
                                <button title="Export to xls" class="btn btn-white btn-info btn-bold" id="export" onClick="fnExcelReport('export', 'dynamic-table', 'RelatedDepartment')">
                                    <span>
                        ...
                        <div class="table-header">
                           <a Class="red" href="@Url.Action("Create", "RELATED_DEPARTMENT", New With {.flag = Convert.ToDecimal(ViewBag.flag)})" title="Create">
                        ...
                        <div>
                            <table id="dynamic-table" Class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    @<tr>
                                        <td>
                                            @item.RELATED_DEPARTMENT_NAME
                                        </td>

                                        @code
                                            Dim appr As String = ""
                                            For Each itemx In item.TPROC_APPR_RELDEPT_GR.TPROC_APPR_RELDEPT_DT
                                                appr = appr + itemx.USER_NAME + ";  "
                                            Next
                                    @<td class="">
                                        @appr
                                    </td>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green" href="@Url.Action("Edit", "RELATED_DEPARTMENT", New With {.id = item.ID, .flag = Convert.ToDecimal(ViewBag.flag)})" title="Edit">
                                                    @Html.Raw(Labels.IconAction("Edit"))
                                                </a>

                                                <a class="red" href="@Url.Action("Delete", "RELATED_DEPARTMENT", New With {.id = item.ID, .flag = Convert.ToDecimal(ViewBag.flag)})" title="Delete">
