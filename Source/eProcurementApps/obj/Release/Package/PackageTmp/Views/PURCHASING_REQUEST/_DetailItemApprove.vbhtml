    ...
    <div class="modal-content">
        <div class="modal-header no-padding">
            <div class="table-header">
                ...
                Confirmation approve item for PR No : @Model.TPROC_PR_HEADER.PR_NO
            </div>
        </div>
        ...
        <div class='modal-footer no-margin-top'>
            ...
            @If ViewBag.StatusApprWA <> "Approved" Then
            @Html.Raw(Labels.ButtonForm("SaveItemPRApprove"))
            @Html.Raw(Labels.ButtonForm("SaveItemPRRejectByApprover"))
            End If
            <hr />
