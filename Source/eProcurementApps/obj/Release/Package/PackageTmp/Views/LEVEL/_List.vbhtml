@ModelType IEnumerable(Of eProcurementApps.Models.TPROC_LEVEL)
                    ...
                    <div Class="col-xs-12">
                        <div Class="clearfix">
                            <div Class="pull-right tableTools-container">
                                <button title="Export to xls" class="btn btn-white btn-info btn-bold" id="export" onClick="fnExcelReport('export', 'dynamic-table', 'Level')">
                                    <span>
                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Indonesia Level</th>
                                        <th>Rupiah Limit</th>
                                        <th>Canadian Dolars</th>
                                        <th>Created Time</th>
                                        <th>Created By</th>
                                ...
                                <tbody>
                                    @For Each item In Model
                                        @<tr>
                                            ...
                                            <td>
                                                @item.INDONESIAN_LEVEL
                                            </td>
                                            <td>
                                                @item.RUPIAH_LIMIT.ToString("###,###")
                                            </td>
                                            <td>
                                                @item.CANADIAN_DOLLARS.ToString("###,###")
                                            </td>
                                            <td align="right">
