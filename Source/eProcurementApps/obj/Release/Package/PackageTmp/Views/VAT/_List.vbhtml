@ModelType IEnumerable(Of eProcurementApps.Models.TPROC_VAT)
                    ...
                    <div Class="col-xs-12">
                        <div Class="clearfix">
                            <div Class="pull-right tableTools-container">
                                <button title="Export to xls" class="btn btn-white btn-info btn-bold" id="export" onClick="fnExcelReport('export', 'dynamic-table', 'VAT')">
                                    <span>
                                ...
                                <tbody>
                                    @For Each item In Model
                                        @<tr>
                                            ...
                                            <td align="right">
                                                @item.START_DATE.ToString("d-MMM-yy")
                                            </td>
                                            <td align="right">
