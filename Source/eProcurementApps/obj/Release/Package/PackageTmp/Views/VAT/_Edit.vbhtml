@ModelType eProcurementApps.Models.TPROC_VAT
        ...
        <div class="modal-body no-padding">
            <div class="profile-user-info">
                ...
                <div class="profile-info-row">
                    <div class="profile-info-name required"> Vat </div>
                    <div class="profile-info-value item-required">
                        <span class="freeText change" id="txt_vat_name" maxlenght="10">@Model.VAT_NAME</span>
                        <label id="required_txt_vat_name"></label>
                    </div>
                </div>
